...
ACCELERATE_LOG_LEVEL=info accelerate launch --config_file /mnt/cache/luzimu/mathllm-finetune/recipes/accelerate_configs/deepspeed_zero3_8gpu.yaml /mnt/cache/luzimu/mathllm-finetune/scripts/run_sft_lce.py ${CONFIG}