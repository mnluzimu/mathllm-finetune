...
OMP_NUM_THREADS=1 torchrun --nnodes $WORLD_SIZE --node_rank $RANK --master_addr $MASTER_ADDR --master_port $MASTER_PORT --nproc_per_node 8 /mnt/cache/luzimu/mathllm-finetune/scripts/run_sft_tool.py ${CONFIG}