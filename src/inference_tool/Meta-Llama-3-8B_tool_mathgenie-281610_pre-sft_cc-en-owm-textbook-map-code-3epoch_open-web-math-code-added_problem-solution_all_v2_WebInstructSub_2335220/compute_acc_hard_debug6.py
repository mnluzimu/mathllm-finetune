...
def main():
    ...
    for name in names:
        ...
        f"/mnt/cache/luzimu/mathllm-finetune/results/inference/{dir}/{name}/{name}_test_result_debug6.jsonl",
        name)
        accs.append(acc)
    ...
    print(table)
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "tmp6.md"), "w", encoding="utf-8") as f:
        f.write(table)
