...
def watch(dir):
    ...
    count = {}
    for ch in chs:
        count[ch] = {"GSM8K": 0, "MATH_0": 0, "MATH_1": 0, "MATH_2": 0, "MATH_3": 0, "SVAMP": 0, "mathematics": 0, "ocw": 0, "aime24": 0, "amc23": 0, "carp_en": 0, "college_math": 0, "olympiadbench": 0}
    while True:
        for ch in chs:
            print(f"{ch}:")
            dir1 = dir + "/" + ch
            for name in count[ch].keys():
