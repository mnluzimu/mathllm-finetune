...
--output_dir /mnt/cache/luzimu/mathllm-finetune/out/Meta-Llama-3-8B_tool_numinamath-lce_3epoch_mathcoder2 \
--logging_dir /mnt/cache/luzimu/mathllm-finetune/out/Meta-Llama-3-8B_tool_numinamath-lce_3epoch_mathcoder2 \
...
--report_to wandb \
--run_name Meta-Llama-3-8B_tool_numinamath-lce_3epoch_mathcoder2 \
--save_total_limit 5 \