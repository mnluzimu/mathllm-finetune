...
--ddp_timeout 3600 \
--processor dialogue \
--model_cfg /mnt/cache/sharemath/models/qwen/Qwen2.5-Math-7B \
--train_file /mnt/cache/k12_data/data_lzm/NuminaMath-CoT/jsonl/numinamath-cot_859494.jsonl \
--output_dir /mnt/cache/luzimu/mathllm-finetune/out/Qwen2_5-Math-7B_numinamath-cot_2epoch \
--logging_dir /mnt/cache/luzimu/mathllm-finetune/out/Qwen2_5-Math-7B_numinamath-cot_2epoch \
...
--report_to wandb \
--run_name Qwen2_5-Math-7B_numinamath-cot_2epoch \
--save_total_limit 3 \