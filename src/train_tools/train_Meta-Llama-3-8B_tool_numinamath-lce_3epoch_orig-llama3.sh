...
--ddp_timeout 3600 \
--processor dialogue \
--model_cfg /mnt/cache/sharemath/models/llama/Meta-Llama-3-8B \
--train_file /mnt/cache/k12_data/data_lzm/NuminaMath-TIR/jsonl/numinamath-lce_72441.jsonl \
--output_dir /mnt/cache/luzimu/mathllm-finetune/out/Meta-Llama-3-8B_tool_numinamath-lce_3epoch_orig-llama3 \
--logging_dir /mnt/cache/luzimu/mathllm-finetune/out/Meta-Llama-3-8B_tool_numinamath-lce_3epoch_orig-llama3 \
...
--report_to wandb \
--run_name Meta-Llama-3-8B_tool_numinamath-lce_3epoch_orig-llama3 \
--save_total_limit 5 \