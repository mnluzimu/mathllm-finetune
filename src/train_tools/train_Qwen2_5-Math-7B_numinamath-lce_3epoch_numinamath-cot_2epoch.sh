...
--ddp_timeout 3600 \
--processor dialogue \
--model_cfg /mnt/cache/luzimu/mathllm-finetune/out/Qwen2_5-Math-7B_numinamath-cot_2epoch-10022154 \
--train_file /mnt/cache/k12_data/data_lzm/NuminaMath-TIR/jsonl/numinamath-lce_72441.jsonl \
--output_dir /mnt/cache/luzimu/mathllm-finetune/out/Qwen2_5-Math-7B_numinamath-lce_3epoch_numinamath-cot_2epoch \
--logging_dir /mnt/cache/luzimu/mathllm-finetune/out/Qwen2_5-Math-7B_numinamath-lce_3epoch_numinamath-cot_2epoch \
...
--report_to wandb \
--run_name Qwen2_5-Math-7B_numinamath-lce_3epoch_numinamath-cot_2epoch \
--save_total_limit 4 \