...
def main():
    args = get_args()
    in_file = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/sc_dpo/math/{args.i}_round{args.r}.jsonl'
    source_file = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/sc_dpo/math/to_be_run_{args.i}_round{args.r}.jsonl'
    ...
    out_file_to_be_run = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/sc_dpo/math/to_be_run_{args.i}_round{args.r + 1}.jsonl'
    out_file_result = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/sc_dpo/math/result_{args.i}_round{args.r}.jsonl'
