...
def main_gsm8k_no_ch():
    in_file = "/mnt/cache/luzimu/datasets_en/GSM8K/GSM8K_train.jsonl"
    out_dir = "/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/gsm8k_1"
    n = 18
    get_initial_data(in_file, out_dir, n)

def main_math_no_ch():
    in_file = "/mnt/cache/luzimu/datasets_en/MATH/MATH_train.jsonl"
    out_dir = "/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/math"
    n = 18
    get_initial_data(in_file, out_dir, n)
