...
def main():
    ...
    num_wrong_thresh = 4
    in_file = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/math/{args.i}_round{args.r}.jsonl'
    source_file = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/math/to_be_run_{args.i}_round{args.r}.jsonl'
    result_file = f"/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/math/result_{args.i}.jsonl"
    to_be_run_file = f'/mnt/cache/luzimu/rlhf_math/data/lce_solutions/internlm_no_ch_negative_positive_gen/naive_dpo/math/to_be_run_{args.i}_round{args.r + 1}.jsonl'
